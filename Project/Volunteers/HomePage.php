    ...
    <div class="min-h-screen flex flex-col">
            ...
            <div class="flex justify-between">
                ...
                <div class="p-1 flex flex-row items-center">
                    <div class="profile-image-container">
                        <!-- <img id="profileImage" onclick="profileToggle()" class="inline-block h-8 w-8 rounded-full" alt=""> -->
                        <input type="file" class="file-input" id="fileInput" accept="image/*" onchange="previewImage(event)">
                        <label class="file-label p-1" for="fileInput">
        ...
        <div class="flex flex-1">
            ...
            <main class="bg-white-300 flex-1 p-3 overflow-hidden">
                <h2 class="text-center text-2xl">Welcome to the Volunteer Dashboard</h2>
                <p class="text-center text-lg">You can manage your attendance and profile using the links on the left.</p>
            </main>
            <!--/Main-->
        </div>
    </div>
