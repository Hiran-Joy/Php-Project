...
<div class="mx-auto bg-grey-400">
    ...
    --> <input type="file" class="file-input" id="fileInput" accept="image/*" onchange="previewImage(event)">
                    ...
                    <a href="#" onclick="profileToggle()" class="text-white p-2 no-underline hidden md:block lg:block">Media Committee</a>
                </div>
            </div>
        </header>
        <!--/Header-->
        ...
        <div class="flex flex-1">
            ...
            <aside id="sidebar" class="bg-side-nav w-1/2 md:w-1/6 lg:w-1/6 border-r border-side-nav hidden md:block lg:block">
                <ul class="list-reset flex flex-col">
                    ...
                    <li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="../MediaCommittee/ViewEvents.php" class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                    ...
                    <li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="../MediaCommittee/ViewMedia.php" class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                            <i class="fas fa-image float-left mx-2"></i>
                            View Media
                            <span><i class="fas fa-angle-right float-right"></i></span>
                        </a>
                    </li>
                    <li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="../MediaCommittee/Complaint.php" class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
            ...
            <main class="bg-white-300 flex-1 p-3 overflow-hidden">
                <h2 class="text-center text-2xl">Welcome to the Media Committe Dashboard</h2>
                <p class="text-center text-lg">You can manage your media and events using the links on the left.</p>
            </main>
            <!--/Main-->
        </div>
    </div>
