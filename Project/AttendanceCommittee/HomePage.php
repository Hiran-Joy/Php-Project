...
if (!isset($_SESSION['aname'])) {
    $_SESSION['aname'] = 'Guest'; // Default value if not set
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="mx-auto bg-grey-400">
    ...
    <div class="min-h-screen flex flex-col">
      ...
      -->  <input type="file" class="file-input" id="fileInput" accept="image/*" onchange="previewImage(event)">
                    ...
                    <a href="#" onclick="profileToggle()" class="text-white p-2 no-underline hidden md:block lg:block">Attendance Committee</a>
                </div>
            </div>
        </header>
        <!--/Header-->
        ...
        <div class="flex flex-1">
            ...
            <aside id="sidebar" class="bg-side-nav w-1/2 md:w-1/6 lg:w-1/6 border-r border-side-nav hidden md:block lg:block">
                <ul class="list-reset flex flex-col">
                    ...
                    <li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="../AttendanceCommittee/Complaint.php" class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
            ...
            <main class="bg-white-300 flex-1 p-3 overflow-hidden">
                <h2 class="text-center text-2xl">Welcome to the Attendance Committee Dashboard</h2>
                <p class="text-center text-lg">You can manage your events, attendance, profile and more using the links on the left.</p>
            </main>
            <!--/Main-->
        </div>
    </div>
