...
<div class="mx-auto bg-grey-400">
    ...
    --><input type="file" class="file-input" id="fileInput" accept="image/*" onchange="previewImage(event)">
                    ...
                    <a href="#" onclick="profileToggle()" class="text-white p-2 no-underline hidden md:block lg:block">Report Committee</a>
                </div>
            </div>
        </header>
        <!--/Header-->
        ...
        <div class="flex flex-1">
            ...
            <aside id="sidebar" class="bg-side-nav w-1/2 md:w-1/6 lg:w-1/6 border-r border-side-nav hidden md:block lg:block">
                <ul class="list-reset flex flex-col">
                    ...
                    <li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="../ReportCommittee/ViewEvents.php" class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                    ...
                    <li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="../ReportCommittee/ViewReport.php" class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                    ...
                    <li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="../ReportCommittee/Complaint.php" class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                            <i class="fas fa-file-alt float-left mx-2"></i>
                            Report Complaint
                            <span><i class="fas fa-angle-right float-right"></i></span>
                        </a>
            ...
            <main class="bg-white-300 flex-1 p-3 overflow-hidden">
                <h2 class="text-center text-2xl">Welcome to the Report Committee Dashboard</h2>
                <p class="text-center text-lg">You can manage your reports and events using the links on the left.</p>
            </main>
            <!--/Main-->
        </div>
    </div>
