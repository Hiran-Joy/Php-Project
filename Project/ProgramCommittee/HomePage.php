    ...
    <div class="min-h-screen flex flex-col">
        ...
        <header class="bg-nav">
            <div class="flex justify-between">
                ...
                <div class="p-1 flex flex-row items-center">
                    ...
                    <a href="#" onclick="profileToggle()" class="text-white p-2 no-underline hidden md:block lg:block">Program Committee</a>
                </div>
            </div>
        </header>
        <!--/Header-->
        ...
        <div class="flex flex-1">
            ...
            <aside id="sidebar" class="bg-side-nav w-1/2 md:w-1/6 lg:w-1/6 border-r border-side-nav hidden md:block lg:block">
                <ul class="list-reset flex flex-col">
                    ...
                    <li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="../ProgramCommittee/Event.php" class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                            <i class="fas fa-plus float-left mx-2"></i>
                            Add Events
                            <span><i class="fas fa-angle-right float-right"></i></span>
                        </a>
                    </li>
                    <li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="../ProgramCommittee/ViewEvents.php" class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                    ...
                    <li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="../ProgramCommittee/Complaint.php" class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
            ...
            <main class="bg-white-300 flex-1 p-3 overflow-hidden">
                <h2 class="text-center text-2xl">Welcome to the Program Committee Dashboard</h2>
                <p class="text-center text-lg">You can manage your events using the links on the left.</p>
            </main>
            <!--/Main-->
        </div>
    </div>
